...
<body style="margin:0;height:100%;">
	...
	+ 'DOMAINID="<%=domainId %>" USERNAME="<%=userName %>" PASSWORD="<%=password %>" PROTOCOL="<%=protocol %>" HOSTIP="<%=hostIp %>" HOSTPORT="<%=hostPort %>" LDAP="<%=ldap %>">'
	+ '<noembed></noembed>'
	+ '</EMBED>'
	+ '</COMMENT>'
	+ '</OBJECT></div>';
	...
	if (navigator.userAgent.indexOf('MSIE') > -1 || navigator.userAgent.indexOf("rv") > -1 || navigator.userAgent.indexOf("EDGE") > -1) {
