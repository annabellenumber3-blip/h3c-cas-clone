...
pathUrl = 'layer/', //上述变量为false才有效，当前layerjs所在目录(不用填写host，相对站点的根目录即可)。
...
Class.pt.space = function(html){
    ...
    config.closeBtn[1] && (closebtn = '<a class="xubox_close xubox_close' + config.closeBtn[0] +' single-word-icon" style="color:#FFFFFF;font-size:20px;" href="javascript:;"></a>');
