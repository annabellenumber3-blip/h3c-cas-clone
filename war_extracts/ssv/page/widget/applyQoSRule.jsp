...
<body>
  <div id="modal" class="modal" style="position: relative;width:600px;height:auto">
    ...
    <div class="modal-content">
		<form id="applyQoSRuleFormId" class="form form-horizontal cloudsafety" style="border:1px;height:auto">
			<div class="item">
			...
			<div class="item" >
				...
				<div class="controls">
					<input id="qosRuleEnabledId" style="align:left;" type="checkbox" name="enabled" value="1">
				</div>
			</div>
			<div class="item" >
				<div class="control-label">
  ...
  function submitApplyQoSRule() {
	...
	if (name == '') {
  	...
  	//var flag = $('#applyQoSRuleFormId').form('validate');
  	if ( !flag ) {
  		return;
  	} else {
  		...
  		$.ajax({
  			type : "POST",
  			dataType : "json",
  			url : "servlet/firewallServlet?way=applyQoSRule",
  			data : "xml=" + xml,
