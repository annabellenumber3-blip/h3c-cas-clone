...
#define __NR_kabi_reserved441 (__X32_SYSCALL_BIT + 441)
#define __NR_kabi_reserved442 (__X32_SYSCALL_BIT + 442)
#define __NR_kabi_reserved443 (__X32_SYSCALL_BIT + 443)
#define __NR_kabi_reserved444 (__X32_SYSCALL_BIT + 444)
#define __NR_kabi_reserved445 (__X32_SYSCALL_BIT + 445)
#define __NR_kabi_reserved446 (__X32_SYSCALL_BIT + 446)
#define __NR_kabi_reserved447 (__X32_SYSCALL_BIT + 447)
#define __NR_kabi_reserved448 (__X32_SYSCALL_BIT + 448)
#define __NR_kabi_reserved449 (__X32_SYSCALL_BIT + 449)
#define __NR_kabi_reserved450 (__X32_SYSCALL_BIT + 450)
#define __NR_kabi_reserved451 (__X32_SYSCALL_BIT + 451)
#define __NR_kabi_reserved452 (__X32_SYSCALL_BIT + 452)
#define __NR_kabi_reserved453 (__X32_SYSCALL_BIT + 453)
#define __NR_kabi_reserved454 (__X32_SYSCALL_BIT + 454)
#define __NR_kabi_reserved455 (__X32_SYSCALL_BIT + 455)
#define __NR_kabi_reserved456 (__X32_SYSCALL_BIT + 456)
