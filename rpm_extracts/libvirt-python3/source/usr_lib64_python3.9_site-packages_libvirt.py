...
class virDomain(object):
    ...
    def agentSetResponseTimeout(self, timeout, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainAgentSetResponseTimeout() failed', dom=self)
        return ret
    ...
    def backupGetXMLDesc(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainBackupGetXMLDesc() failed', dom=self)
        return ret
    ...
    def checkpointCreateXML(self, xmlDesc, flags=0):
        ...
        if ret is None:raise libvirtError('virDomainCheckpointCreateXML() failed', dom=self)
    ...
    def checkpointLookupByName(self, name, flags=0):
        ...
        if ret is None:raise libvirtError('virDomainCheckpointLookupByName() failed', dom=self)
        __tmp = virDomainCheckpoint(self,_obj=ret)
        return __tmp
    ...
    def colo(self, xml, flags=0):
        """Started the domain colo, and convert the role of the domain to
        primary or secondary """
        ret = libvirtmod.virDomainColo(self._o, xml, flags)
        if ret == -1: raise libvirtError ('virDomainColo() failed', dom=self)
        return ret
    ...
    def domainLiveUpdate(self, domainXml):
        """Reads a domain XML configuration document, live update
        the qemu process. """
        ret = libvirtmod.virConnectDomainLiveUpdate(self._o, domainXml)
        if ret == -1: raise libvirtError ('virConnectDomainLiveUpdate() failed', dom=self)
        return ret
    ...
    def extraneousInformation(self, flagnum, params, nparams):
        """This function is to get vm extraneous information
        
        Domains may have more than one ExtraneousInformation.  To get  params for
        ...
        As a special case, calling with @params as None and @nparams as 0 on
        input will cause @nparams on output to contain the number of parameters
        supported by the hypervisor. """
        ret = libvirtmod.virDomainExtraneousInformation(self._o, flagnum, params, nparams)
        if ret == -1: raise libvirtError ('virDomainExtraneousInformation() failed', dom=self)
        return ret
    ...
    def guestInfo(self, types=0, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainGetGuestInfo() failed', dom=self)
        return ret
    ...
    def liveUpdateReconnect(self, pid):
        """Reset the VM process parameters using a new process ID. """
        ret = libvirtmod.virDomainLiveUpdateReconnect(self._o, pid)
        if ret == -1: raise libvirtError ('virDomainLiveUpdateReconnect() failed', dom=self)
        return ret
    ...
    def setCgroupMemSwappiness(self, swappiness, flags=0):
        """Set Cgroup memory swappiness for this domain. """
        ret = libvirtmod.virDomainSetCgroupMemSwappiness(self._o, swappiness, flags)
        if ret == -1: raise libvirtError ('virDomainSetCgroupMemSwappiness() failed', dom=self)
        return ret
    ...
    def setUcacheMode(self, mode):
        """Set ucache normal/no new write/no flush base on mode """
        ret = libvirtmod.virDomainSetUcacheMode(self._o, mode)
        if ret == -1: raise libvirtError ('virDomainSetUcacheMode() failed', dom=self)
        return ret
    ...
    def setVcacheStatus(self, status):
        """Turn vcache on or off based on the status """
        ret = libvirtmod.virDomainSetVcacheStatus(self._o, status)
        if ret == -1: raise libvirtError ('virDomainSetVcacheStatus() failed', dom=self)
        return ret
    ...
    def upgrade(self, dconn, params, nparams, flags=0):
        if dconn is None: dconn__o = None
        else: dconn__o = dconn._o
        ret = libvirtmod.virDomainUpgrade(self._o, dconn__o, params, nparams, flags)
        if ret is None:raise libvirtError('virDomainUpgrade() failed', dom=self)
        __tmp = virDomain(self,_obj=ret)
        return __tmp
...
class virNetwork(object):
    ...
    def portCreateXML(self, xmldesc, flags=0):
        ...
        if ret is None:raise libvirtError('virNetworkPortCreateXML() failed', net=self)
    ...
    def portLookupByUUID(self, uuid):
        ...
        if ret is None:raise libvirtError('virNetworkPortLookupByUUID() failed', net=self)
        __tmp = virNetworkPort(self, _obj=ret)
        return __tmp
    ...
    def portLookupByUUIDString(self, uuidstr):
        ...
        if ret is None:raise libvirtError('virNetworkPortLookupByUUIDString() failed', net=self)
        __tmp = virNetworkPort(self, _obj=ret)
        return __tmp
...
class virNetworkPort(object):
    ...
    def UUID(self):
        ...
        if ret is None: raise libvirtError ('virNetworkPortGetUUID() failed')
        return ret

    def UUIDString(self):
        """Fetch globally unique ID of the network port as a string. """
        ret = libvirtmod.virNetworkPortGetUUIDString(self._o)
        if ret is None: raise libvirtError ('virNetworkPortGetUUIDString() failed')
        return ret
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virNetworkPortGetXMLDesc() failed')
        return ret
    ...
    def delete(self, flags=0):
        ...
        if ret == -1: raise libvirtError ('virNetworkPortDelete() failed')
        return ret
    ...
    def parameters(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virNetworkPortGetParameters() failed')
        return ret
    ...
    def setParameters(self, params, flags=0):
        ...
        if ret == -1: raise libvirtError ('virNetworkPortSetParameters() failed')
        return ret
...
class virStoragePool(object):
    ...
    def createXMLBrief(self, xmldesc, flags=0):
        """Create storage vol by XML Brief """
        ret = libvirtmod.virStorageVolCreateXMLBrief(self._o, xmldesc, flags)
        if ret == -1: raise libvirtError ('virStorageVolCreateXMLBrief() failed', pool=self)
        return ret
    ...
    def deleteBrief(self, vol_name, flags=0):
        """Delete storage vol Brief """
        ret = libvirtmod.virStorageVolDeleteBrief(self._o, vol_name, flags)
        if ret == -1: raise libvirtError ('virStorageVolDeleteBrief() failed', pool=self)
        return ret
    ...
    def lockAcquire(self, flags=0):
        """Lock or unlock storage pool """
        ret = libvirtmod.virStoragePoolLockAcquire(self._o, flags)
        if ret == -1: raise libvirtError ('virStoragePoolLockAcquire() failed', pool=self)
        return ret
    ...
    def shutdown(self, flags=0):
        """Shutdown an active storage pool. This will deactivate the
        pool on the host, but keep any persistent config associated
        with it. If it has a persistent config it can later be
        restarted with virStoragePoolCreate(). This does not free
        the associated virStoragePoolPtr object. """
        ret = libvirtmod.virStoragePoolShutdown(self._o, flags)
        if ret == -1: raise libvirtError ('virStoragePoolShutdown() failed', pool=self)
        return ret
    ...
    def listAllVolumesBrief(self, flags=0):
        """Brief list all storage volumes and returns a list of storage volume objects"""
        ret = libvirtmod.virStoragePoolListAllVolumesBrief(self._o, flags)
        if ret is None:
            raise libvirtError("virStoragePoolListAllVolumesBrief() failed", conn=self)
...
class virConnect(object):
    ...
    def getStoragePoolCapabilities(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virConnectGetStoragePoolCapabilities() failed', conn=self)
        return ret
    ...
    def mdevCheck(self, uuid, flags=0):
        """This function is to get mdev residual information """
        ret = libvirtmod.virConnectMdevCheck(self._o, uuid, flags)
        if ret == -1: raise libvirtError ('virConnectMdevCheck() failed', conn=self)
        return ret
    ...
    def setIdentity(self, params, flags=0):
        ...
        if ret == -1: raise libvirtError ('virConnectSetIdentity() failed', conn=self)
        return ret
    ...
    def lockFreeAllStoragePools(self, flags=0):
        """Lock free all storage pools objects"""
        ret = libvirtmod.virConnectLockFreeAllStoragePools(self._o, flags)
        if ret == -1: raise libvirtError ('virConnectLockFreeAllStoragePools() failed', pool=self)
        return ret
...
class virDomainCheckpoint(object):
    ...
    def delete(self, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainCheckpointDelete() failed')
        return ret

    def getName(self):
        """Get the public name for that checkpoint """
        ret = libvirtmod.virDomainCheckpointGetName(self._o)
        if ret is None: raise libvirtError ('virDomainCheckpointGetName() failed')
        return ret
    ...
    def getParent(self, flags=0):
        ...
        if ret is None:raise libvirtError('virDomainCheckpointGetParent() failed', dom=self._dom)
        __tmp = virDomainCheckpoint(self,_obj=ret)
        return __tmp
    ...
    def getXMLDesc(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainCheckpointGetXMLDesc() failed')
        return ret
...
VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_QGA_UPGRADE = 3
VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_QUERY_MEMORY = 4
VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_QUERY_CPU = 5
...
VIR_CONNECT_LIST_STORAGE_POOLS_FC = 1073741824
...
VIR_DOMAIN_BLOCK_JOB_INFO_PERSIST = 2
...
# virDomainColoFlags
VIR_DOMAIN_COLO_START = 4
VIR_DOMAIN_COLO_FAILOVER = 8
VIR_DOMAIN_COLO_RESUME = 16
...
VIR_DOMAIN_DEVICE_MODIFY_DISK_SERIAL_ID = 8
...
VIR_DOMAIN_EVENT_RESUMED_COLO = 4
...
VIR_DOMAIN_EVENT_STARTED_NOTIFY_HA = 5
...
VIR_DOMAIN_EVENT_STOPPED_NOTIFY_HA = 7
...
VIR_DOMAIN_EVENT_SUSPENDED_COLO = 9
...
VIR_MIGRATE_ALLOWED_HOSTDEV = 262144
VIR_MIGRATE_ZEROCOPY = 524288
VIR_MIGRATE_SHAREMEMORY = 1048576
VIR_MIGRATE_NORMALMEMORY = 2097152
...
VIR_DOMAIN_PAUSED_UPGRADE = 14
VIR_DOMAIN_PAUSED_COLO = 15
...
VIR_DOMAIN_SNAPSHOT_CREATE_NO_VMSTATE = 4096
VIR_DOMAIN_SNAPSHOT_CREATE_MIGRATE_MEMORY = 8192
VIR_DOMAIN_SNAPSHOT_CREATE_EXTERNAL_MEMORY = 16384
...
VIR_DOMAIN_SNAPSHOT_DELETE_EXTERNALMEM = 8
...
VIR_DOMAIN_XML_AUTOSTART_RESULT = 16
...
VIR_NODE_ALLOC_PAGES_DEL = 1
VIR_NODE_ALLOC_PAGES_SET = 1
VIR_NODE_ALLOC_PAGES_FREE = 2
...
VIR_STORAGE_POOL_EVENT_SHUTDOWN = 6
...
VIR_STORAGE_POOL_LOCK = 1
VIR_STORAGE_POOL_UNLOCK = 2
...
VIR_STORAGE_VOL_CREATE_PREALLOC_FALLOC = 64
VIR_STORAGE_VOL_CREATE_PREALLOC_FULL = 128
VIR_STORAGE_VOL_CREATE_INC_IMAGE_BY_CP = 256
...
VIR_DOMAIN_DYNAMIC_SET_MEMORY_NUM = "cyclenumber"
...
VIR_DOMAIN_RESERVED_MEMORY = "reservedmemory"
...
VIR_MIGRATE_PARAM_DEST_IFNAME = "destination_ifname"
