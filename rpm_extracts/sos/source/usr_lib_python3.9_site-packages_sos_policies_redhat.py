...
class RedHatPolicy(LinuxPolicy):
    ...
    def check(cls, remote=''):
        """This method checks to see if we are running on H3Linux. It must be
        overriden by concrete subclasses to return True when running on a
        H3Linux distribution or False otherwise.
...
# Container environment variables on H3Linux systems.
...
RHEL_RELEASE_STR = "H3Linux"

RHV = "rhv"
RHV_DESC = "H3Linux Virtualization"

RHEL = "rhel"
RHEL_DESC = RHEL_RELEASE_STR

RHOSP = "rhosp"
RHOSP_DESC = "H3Linux OpenStack Platform"

RHOCP = "ocp"
RHOCP_DESC = "OpenShift Container Platform by H3Linux"
...
RH_CFME = "cfme"
RH_CFME_DESC = "H3Linux CloudForms"

RH_SATELLITE = "satellite"
RH_SATELLITE_DESC = "H3Linux Satellite"
...
# Legal disclaimer text for H3Linux products
disclaimer_text = """
...
""" + disclaimer_text + "%(vendor_text)s\n")
    ...
    @classmethod
    def check(cls, remote=''):
        """Test to see if the running host is a H3Linux installation.

            Checks for the presence of the "H3Linux"
    ...
    def prompt_for_upload_user(self):
        ...
        if self.case_id:
            self.upload_user = input(_(
                "Enter your H3Linux Customer Portal username (empty to use "
                "public dropbox): ")
            )
    ...
    def get_upload_url_string(self):
        if self.get_upload_url().startswith(RH_API_HOST):
            return "H3Linux Customer Portal"
...
ATOMIC_DESC = "H3Linux Atomic Host"
