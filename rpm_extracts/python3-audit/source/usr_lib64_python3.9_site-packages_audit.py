...
class audit_rule_data(object):
    ...
    buf = property(_audit.audit_rule_data_buf_get, _audit.audit_rule_data_buf_set)
...
def audit_format_signal_info(buf: "char *", len: "int", op: "char *", rep: "audit_reply", res: "char *") -> "char *":
...
def audit_reset_backlog_wait_time_actual(fd: "int") -> "int":
...
def audit_rule_create_data() -> "struct audit_rule_data *":
    return _audit.audit_rule_create_data()

def audit_rule_init_data(rule: "audit_rule_data") -> "void":
