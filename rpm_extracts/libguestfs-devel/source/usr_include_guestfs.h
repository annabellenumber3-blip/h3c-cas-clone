...
#define GUESTFS_ADD_DRIVE_OPTS_CONFIGFILE 7
#define GUESTFS_ADD_DRIVE_OPTS_USERNAME 8
#define GUESTFS_ADD_DRIVE_OPTS_SECRET 9
#define GUESTFS_ADD_DRIVE_OPTS_CACHEMODE 10
#define GUESTFS_ADD_DRIVE_OPTS_DISCARD 11
#define GUESTFS_ADD_DRIVE_OPTS_COPYONREAD 12
...
# define GUESTFS_ADD_DRIVE_OPTS_SERVER_BITMASK (UINT64_C(1)<<6)
  char *const *server;
# define GUESTFS_ADD_DRIVE_OPTS_CONFIGFILE_BITMASK (UINT64_C(1)<<7)
  const char *configfile;
# define GUESTFS_ADD_DRIVE_OPTS_USERNAME_BITMASK (UINT64_C(1)<<8)
  const char *username;
# define GUESTFS_ADD_DRIVE_OPTS_SECRET_BITMASK (UINT64_C(1)<<9)
  const char *secret;
# define GUESTFS_ADD_DRIVE_OPTS_CACHEMODE_BITMASK (UINT64_C(1)<<10)
  const char *cachemode;
# define GUESTFS_ADD_DRIVE_OPTS_DISCARD_BITMASK (UINT64_C(1)<<11)
  const char *discard;
# define GUESTFS_ADD_DRIVE_OPTS_COPYONREAD_BITMASK (UINT64_C(1)<<12)
  int copyonread;
};
