...
typedef enum {
    ...
    VIR_DOMAIN_SNAPSHOT_CREATE_VALIDATE    = (1 << 9), /* validate the XML
                                                          against the schema */
    VIR_DOMAIN_SNAPSHOT_CREATE_NO_VMSTATE  = (1 << 12), /* just create the disk
                                                           snapshot while the
                                                           guest is running */
    VIR_DOMAIN_SNAPSHOT_CREATE_MIGRATE_MEMORY = (1 << 13), /* save memory by
                                                              migrate and
                                                              snapshot disks */
    VIR_DOMAIN_SNAPSHOT_CREATE_EXTERNAL_MEMORY = (1 << 14), /* save memory when take
                                                               external snapshot */
...
typedef enum {
    ...
    VIR_DOMAIN_SNAPSHOT_DELETE_EXTERNALMEM = (1 << 3),   /* Delete external memory image */
