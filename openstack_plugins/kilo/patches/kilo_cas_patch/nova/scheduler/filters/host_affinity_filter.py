...
class _HostAntiAffinityFilter(filters.BaseHostFilter):
    ...
    hosts.
    """
    def host_passes(self, host_state, filter_properties, *args, **kwargs):
...
class _HostAffinityFilter(filters.BaseHostFilter):
    ...
    def host_passes(self, host_state, filter_properties, *args, **kwargs):
        ...
        for instance in instances:
            if filter_properties.get('instance_uuid') == instance.uuid:
                continue
