...
class CASNeutronAgent(object):
    def __init__(self, binary, agent_type, use_call):
        ...
        self._agent_state = {'binary': binary,
                             ...
                             'configurations':{'CAS_IP':CONF.cas.host_ip},
                             'start_flag': True}
...
class CASNeutronSriovAgent(CASNeutronAgent):
    ...
    def __init__(self, binary):
        ...
        self.physical_device_mappings = CONF.sriov_nic.physical_device_mappings or CONF.cas.physical_device_mappings
...
class CASNeutronOvsAgent(CASNeutronAgent):
    ...
    def __init__(self, binary):
        ...
        self.bridge_mappings = CONF.ovs.bridge_mappings or CONF.cas.bridge_mappings
