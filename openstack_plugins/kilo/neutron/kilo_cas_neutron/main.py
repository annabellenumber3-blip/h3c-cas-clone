...
cas_bridge_mappings_opt = [
    cfg.ListOpt('bridge_mappings',
                help='list of bridge mappings. Required if '
                     'neutron agent is casagent. '),
    ]
cas_device_mappings_opt = [
    cfg.ListOpt('physical_device_mappings',
                help='list of bridge mappings. Required if '
                     'neutron agent is casagent. '),
    ]
...
CONF = cfg.CONF
CONF.register_opts(cas_bridge_mappings_opt, 'ovs')
CONF.register_opts(cas_device_mappings_opt, 'sriov_nic')
CONF.register_opts(casapi_opts+cas_bridge_mappings_opt+cas_device_mappings_opt, 'cas')
