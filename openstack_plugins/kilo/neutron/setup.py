...
def _post_install():
    ...
    srcDir = _get_purelib() + '/kilo_cas_neutron'
    ...
    os.system("echo \"echo 'kilo_cas_neutron R0785P03'\" >> /usr/bin/openstack-cas-version")
