...
import logging
logging.basicConfig(filename="/var/log/cas_glance.log", level=logging.INFO)
...
class HTTPSClientAuthConnection(http_client.HTTPSConnection):
    ...
    :see http://code.activestate.com/recipes/
            577548-https-http_client-client-connection-with-certificate-v/
    """

    def __init__(self, host, port, key_file, cert_file,
                 ca_file, timeout=None, insecure=False):
        http_client.HTTPSConnection.__init__(self, host, port, key_file=key_file,
                                         cert_file=cert_file)
    ...
    def connect(self):
        ...
        Redefined/copied and extended from http_client.py:1105 (Python 2.6.x).
...
class BaseClient(object):
    ...
    def get_status_code(self, response):
        ...
        can be either a Webob.Response (used in testing) or http_client.Response
        """
