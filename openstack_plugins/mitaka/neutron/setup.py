...
def _post_install():
    ...
    srcDir = _get_purelib() + '/mitaka_cas_neutron'
    ...
    if os.path.exists('/usr/bin/openstack-cas-version'):
        os.system("sed -i /mitaka_cas_neutron/d /usr/bin/openstack-cas-version")
    os.system("echo \"echo 'mitaka_cas_neutron R0785P03'\" >> /usr/bin/openstack-cas-version")
