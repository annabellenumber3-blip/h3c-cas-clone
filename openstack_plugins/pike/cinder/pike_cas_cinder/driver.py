...
HP3PARDriver = ['cinder.volume.drivers.hpe.hpe_3par_iscsi.HPE3PARISCSIDriver',
...
class Extend3PARDriver(object):
    def __init__(self, driver, *args,**kwargs):
        ...
        self._driver = importutils.import_object(driver,*args,**kwargs)
        self._hp3parclient = importutils.try_import("hpe3parclient")
        self.db = kwargs['db']
    ...
    def _get_iscsi_connection_info(self, common, vlunId):
        iscsi_ips = self._driver.iscsi_ips[common._client_conf['hpe3par_api_url']]
    ...
    def initialize_connection(self, volume, connector, *args, **kwargs):
        ...
        try:
            ...
            if self._driver_string == 'cinder.volume.drivers.hpe.hpe_3par_iscsi.HPE3PARISCSIDriver':
