...
from nova.api.openstack.compute.legacy_v2.contrib import origin_server_groups
...
SUPPORTED_POLICIES.extend(['host-anti-affinity', 'host-affinity'])

origin_controller_class = ServerGroupController

class ServerGroupController():
    def __init__(self, ext_mgr, *args, **kwargs):
        self._controller = origin_controller_class(ext_mgr,*args,**kwargs)
