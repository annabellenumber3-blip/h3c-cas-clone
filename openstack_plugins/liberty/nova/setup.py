...
def _post_install():
    ...
    srcDir = _get_purelib() + '/liberty_cas_nova'
    ...
    if os.path.exists('/usr/bin/openstack-cas-version'):
        os.system("sed -i /liberty_cas_nova/d /usr/bin/openstack-cas-version")
    os.system("echo \"echo 'liberty_cas_nova R0785P03'\" >> /usr/bin/openstack-cas-version")
